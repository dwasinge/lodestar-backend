...
public class GetEngagementResource extends BackendResource {
    ...
    public List<Engagement> getAll(@QueryParam("categories") String categories, @BeanParam SingleFilterOptions filterOptions) {
        return getEngagementService().getAll(categories, filterOptions);
    }
