package com.redhat.labs.lodestar.resource.category;
...
public class GetCategoryResource extends BackendResource {
    ...
    public List<Category> list(@BeanParam ListFilterOptions options) {
        return getEngagementService().getCategories(options);
    }
